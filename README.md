...
- Pacman:
      ...
      sudo pacman -S waypaper kitty firefox thunar ttf-meslo-nerd curl wget zsh pfetch swww waybar git python3 bluez-utils brightnessctl pipewire pipewire-pulse ttf-jetbrains-mono-nerd wireplumber
